<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="Nhaphang.aspx.cs" Inherits="webasp.Admin.WebForm4" Title="Nhập hàng" %>
        ...
        <div style="width: 801px">
            ...
            <div style="width: 796px; margin-left: 0px">
                <table style="height: 69px; margin-top: 0px; width: 304px;" align="center">
                 <tr>
                        <td class="auto-style1" style="color: #000000" width="45%">
                            Mã hoá đơn:</td>
                    ...
                    <tr>
                        ...
                        <td class="style11">
                            ...
                            <cc:calendarextender ID="txtNgay_CalendarExtender" runat="server" Enabled="True"
                                TargetControlID="txtNgay">
                            </cc:calendarextender>
