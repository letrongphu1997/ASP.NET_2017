<%@ Page Language="C#" MasterPageFile="~/TrangChu.Master" AutoEventWireup="true"
    CodeBehind="DangNhap.aspx.cs" Inherits="webasp.WebForm4" Title="Đăng nhập" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Con1" runat="server">
    ...
    <p><b>Chào mừng bạn đến với website thời trang <a href="TrangChu.aspx">PHHT.com</a>!</b><br />
    Hiện tại giỏ hàng của bạn chưa có sản phẩm nào! Bạn hãy quay về trang chủ  !</p>
