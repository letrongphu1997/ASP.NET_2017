<%@ Page Language="C#" MasterPageFile="~/TrangChu.Master" AutoEventWireup="true" CodeBehind="HangMoiVe.aspx.cs" Inherits="web12.WebForm11" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Con1" runat="server">
    ...
    <asp:DataList ID="sanphammoi" runat="server" HorizontalAlign="Center" 
        ...
        <img id="anh" runat="server" src='<%# "images/"+Eval("Image") %>' />
       </a>
       </div>
            <div class="dong">
